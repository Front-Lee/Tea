  ...
  export default {
    ...
    methods: {
      getlist() {
        ...
        yuanAjax(_this,'api/Category/getcat',{
          cat_id: _this.$route.query.id,
          page: _this.page
        },function (res) {
          ...
          if (res.catList.length != 0) {
            ...
            _this.page++;
          } else if (res.catList.length == 0 && !_this.hasloadMore) {
            _this.$toast({
              message: '没有更多数据',
              duration: 1000
            });
          ...
          _this.proList = _this.proList.concat(res.catList)
        })
      },
      loadMore() {
        var _this = this;
    ...
    mounted () {
      ...
      _this.propData.title = _this.$route.query.name;
      _this.getlist();
    }
  }
</script>
